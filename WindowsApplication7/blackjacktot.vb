Public Class blackjacktot
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        counttut = counttut + 1
        If counttut = 1 Then
            lbltuthelp.Text = ("Welcome to the world of gambling a world filled with debt, poverty and sometimes success. ") & vbNewLine & ("here I will be showing you how to play blackjacks ") & vbNewLine & ("A game made for men with balls of steel but played by men with money to burn or nothing to lose")
        ElseIf counttut = 2 Then
            lbltuthelp.Text = ("Anyway let's get started. the rules of the game are simple you have to try get as close to 21 without going bust. For those who dont know bust is when you go over 21. At first this sounds easy but it's not just you playing.....")
        ElseIf counttut = 3 Then
            lbltuthelp.Text = ("You are also playing against the dealer and whoever gets the highest number without going bust wins. The dealer has specific rules by which he must follow for example at the end of the game the dealer draws his cards he must keep going until he reaches 17 he cannot stop before or keep going after. This can be good or bad depending on how you play your cards........")
        ElseIf counttut = 4 Then
            lbltuthelp.Text = ("When it comes to who wins in certain scenarios this can be different depending on the table you're playing at for this table the rules are if it's a draw dealer wins unless both of you get blackjack then player wins blackjack is when you land on 21, if both player and dealer are bust dealer wins.")
